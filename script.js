...
function draw() { // отрисовка
  ...
  if (MENU.bool) {
    context.drawImage(MENU.main, 0, 0, GAME.width, GAME.height); // меню 
  } else {
...
function init() { // файлы, запуск
  MENU.oper.src = "images/menu_oper.png";
  MENU.about.src = "images/menu_about.png";
  MENU.main.src = "images/main_menu.png";
  CAT.fun.src = "images/cat2.png";
  CAT.sad.src = "images/cat3.png";
  CAT.player.src = "images/cat1.png";
  CAT.player_dub.src = CAT.player.src
